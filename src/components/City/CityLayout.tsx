...
import {
  CityPlannerFeatureState,
  CityPlannerFeatureActions,
} from "@/hooks/useCityPlannerFeatures";
...
import { LayersIcon, Maximize2, Minimize2 } from "lucide-react";
...
const CityLayout: React.FC<CityLayoutProps> = ({
  ...
  // Update feature state when streetViewMode changes
  useEffect(() => {
    featureActions.setStreetViewActive(streetViewMode);
  }, [streetViewMode, featureActions]);
  ...
  return (
    <main className="flex-1 p-4 md:p-6 flex flex-col">
      <div className="flex flex-col lg:flex-row gap-6 h-[calc(100vh-12rem)]">
        ...
        <div
          className="flex-1 glass-panel rounded-lg overflow-hidden relative"
          ref={cityGridContainerRef}
        >
          <div className="absolute top-4 left-4 right-4 z-10 flex items-center justify-between">
            <TimeProgressionControls
